...
anova <- aov(Interception ~ N_Treatments*Water_treat_level+Rep, data = df)
print("############## EXP B ##############")
print(" ")
print(summary(anova))
print(TukeyHSD(anova))
...
anova <- aov(Interception ~ Water_treat_level+Rep, data = df)
print("############## EXP C ##############")
print(" ")
print(summary(anova))
print(TukeyHSD(anova))
...
#  filter(UseForRUE == "Yes") %>% # Only use points in which biomass increases (i.e. no senescence)
  group_by(Experiment,UseForRUE, N_Treatments, Water_Treatments,Water_treat_level,Date, Potential) %>%
